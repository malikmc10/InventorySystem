<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehouseInventory.aspx.cs" Inherits="SI_Project.WarehouseInventory" %>
...
<body style="background-color:darkgray">
    ...
    <form id="form2" runat="server">
        ...
        <div id="container">
				...
				<br />
			<h2 style="color:black">Warehouse Stocks</h2>
  ...
  <Columns>
	  <asp:BoundField DataField="Warehouse_Product_Id" HeaderText="Product Number" 
             />
	  <asp:BoundField DataField="Quantity" HeaderText="Quantity" 
            /> 
	  <asp:BoundField DataField="Product_Name" HeaderText="Product Name" 
             />
	  <asp:BoundField DataField="Product_Desc" HeaderText="Product Detail" 
             />
			 ...
			 <div>
                 ...
                 <asp:Button ID="Button1" runat="server" Text="Update" OnClick="Update_Inventory" BackColor="#339933" Width="359px" />
